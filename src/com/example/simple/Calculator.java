...
public class Calculator extends ActionBarActivity {
	...
	/*
	 * private Button btnMC = null; private Button btnMR = null; private Button
	 * btnMM = null; private Button btnMP = null; private Button btnBS = null;
	 */
	private Button btnPerc = null;
	private Button btnSqrRoot = null;
	private Button btnPM = null;
	/*
	 * private Button expSQ = null; private Button expEX = null; private Button
	 * nbtn1 = null; private Button nbtn2 = null; private Button nbtn3 = null;
	 * private Button nbtn4 = null; private Button nbtn5 = null; private Button
	 * nbtn6 = null; private Button nbtn7 = null;
	 */
	...
	private void initScreenLayout() {
		...
		if (width < 300) {
			/*
			 * btnMC.setTextSize(18); btnMR.setTextSize(18);
			 * btnMP.setTextSize(18); btnMM.setTextSize(18);
			...
			/*
			 * expSQ.setTextSize(18); expEX.setTextSize(18);
			 * nbtn1.setTextSize(18); nbtn2.setTextSize(18);
			 * nbtn3.setTextSize(18); nbtn4.setTextSize(18);
			 * nbtn5.setTextSize(18); nbtn6.setTextSize(18);
		...
		/*
		 * btnMP.setTextColor(Color.WHITE); btnMM.setTextColor(Color.WHITE);
		 * btnMR.setTextColor(Color.WHITE); btnMC.setTextColor(Color.WHITE);
		...
		/*
		 * expSQ.setTextColor(Color.WHITE); expEX.setTextColor(Color.WHITE);
		 * 
		 * nbtn1.setTextColor(Color.WHITE); nbtn2.setTextColor(Color.WHITE);
		 * nbtn3.setTextColor(Color.WHITE); nbtn4.setTextColor(Color.WHITE);
		 * nbtn5.setTextColor(Color.WHITE); nbtn6.setTextColor(Color.WHITE);
	...
	private void initControls() {
		...
		/*
		 * btnMC = (Button) findViewById(R.id.btnMC); btnMR = (Button)
		 * findViewById(R.id.btnMR); btnMM = (Button) findViewById(R.id.btnMM);
		 * btnMP = (Button) findViewById(R.id.btnMP); btnBS = (Button)
		 * findViewById(R.id.btnBS);
		 */
		...
		/*
		 * expSQ = (Button) findViewById(R.id.expSQ); expEX = (Button)
		 * findViewById(R.id.expEX); nbtn1 = (Button) findViewById(R.id.nbtn1);
		 * nbtn2 = (Button) findViewById(R.id.nbtn2); nbtn3 = (Button)
		 * findViewById(R.id.nbtn3); nbtn4 = (Button) findViewById(R.id.nbtn4);
		 * nbtn5 = (Button) findViewById(R.id.nbtn5); nbtn6 = (Button)
		 * findViewById(R.id.nbtn6); nbtn7 = (Button) findViewById(R.id.nbtn7);
		 */

		/*
		 * nbtn1.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(12);
		 * 
		 * }
		 * 
		 * });
		 * 
		 * nbtn2.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(7);
		 * 
		 * }
		 * 
		 * });
		 * 
		 * nbtn3.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(8);
		 * 
		 * }
		 * 
		 * });
		 * 
		 * nbtn4.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(9);
		 * 
		 * }
		 * 
		 * });
		 * 
		 * nbtn5.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(10);
		 * 
		 * }
		 * 
		 * });
		 * 
		 * nbtn6.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(11);
		 * 
		 * }
		 * 
		 * });
		 * 
		 * nbtn7.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleEquals(13);
		 * 
		 * }
		 * 
		 * });
		...
		/*
		 * expSQ.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) {
		 * setValue(Double.toString(Math.cbrt(Double.parseDouble(txtCalc
		 * .getText().toString())))); }
		 * 
		 * }); expEX.setOnClickListener(new Button.OnClickListener() { public
		 * void onClick(View v) { handleEquals(6); }
		 * 
		 * });
		 */
		...
		/*
		 * btnMC.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { memNum = 0; } }); btnMR.setOnClickListener(new
		 * Button.OnClickListener() { public void onClick(View v) {
		 * setValue(Double.toString(memNum)); } }); btnMM.setOnClickListener(new
		 * Button.OnClickListener() { public void onClick(View v) { memNum =
		 * memNum - Double.parseDouble(txtCalc.getText().toString()); operator =
		 * 0; } }); btnMP.setOnClickListener(new Button.OnClickListener() {
		 * public void onClick(View v) { memNum = memNum +
		 * Double.parseDouble(txtCalc.getText().toString()); operator = 0; } });
		 * btnBS.setOnClickListener(new Button.OnClickListener() { public void
		 * onClick(View v) { handleBackspace(); } });
		 */
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_settings) {
			...
			Intent in = new Intent(Calculator.this, MainActivity.class);
			startActivity(in);
			return true;
		}
