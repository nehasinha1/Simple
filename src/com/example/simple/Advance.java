...
public class Advance extends ActionBarActivity {
	...
	/*private Button btnMC1 = null;
	private Button btnMR1 = null;*/
	...
	private void initScreenLayout() {
		...
		if (width < 300) {
			/*btnMC1.setTextSize(18);
			btnMR1.setTextSize(18);*/
	...
	/*	btnMR1.setTextColor(Color.WHITE);
		btnMC1.setTextColor(Color.WHITE);*/
	...
	private void initControls() {
		...
		/*btnMC1 = (Button) findViewById(R.id.btnMC);
		btnMR1 = (Button) findViewById(R.id.btnMR);*/
		...
		/*btnMC1.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				memNum = 0;
			}
		});
		btnMR1.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_settings) {
			...
			Intent in = new Intent(Advance.this, MainActivity.class);
			startActivity(in);
			return true;
		}
